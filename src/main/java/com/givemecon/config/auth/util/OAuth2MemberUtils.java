...
public class OAuth2MemberUtils {
    ...
    /**
     * <code>saveNewOrUpdate()</code>에서만 사용되는 helper method. 매개변수로 전달된 {@link Member} entity가 null인지 확인하고, 만약
     * null이 아니라면 이 entity의 OAuth2 provider가 매개변수로 넘어온 registrationId와 같은지 확인한다. 만약 해당하지 않다면, 이미 존재하는
     * 사용자임을 나타내기 위해 {@link OAuth2AuthenticationException}을 던진다.
     *
